...
def calcule_incertitude_val_lamda(rouge,bleu):
    ...
    delta_res=(echelle_lamda/echelle_pixel)*delta_echelle_pixel #On reporte l'incertitude des pixel sur les longueurs d'onde
    delta_lambda_bleu=5
...
print(f'L incertitude sur la résolution : {inc_res}')
...
# Visualisation avec les lignes représentant la FWHM
plt.plot(val_lamda, intbleu, label="Intensité du laser bleu", color="blue")
