...
%variation lin/aire de tant a tant
%therme dominant de l<incertitde thermne A = incertitude de lambda
%comment reduire l<incertitude du spectro calibre avec bleu
%ajouter les unit/ incertitude 
%faire reference graphique 
...
Les résultats des résolution obtenues sont présentés au tableau \ref{res_tab}.
