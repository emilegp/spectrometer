...
\textit{\textbf{Résumé} -- Modélisation d'un spectromètre 4f avec une première lentille
  de focale $f_1=50$ mm, un réseau de diffraction de pas $\Lambda=600\text{ mm}^{-1}$ dont la normale
est orientée à 
...
lentille, de longueur focale $f_1=50$ mm, est déterminée. Ensuite, le réseau de diffraction, d'un pas $\Lambda=600\text{ mm}^{-1}$ 
...
\end{figure}
 ...
 \begin{figure}[H]
    ...
    \caption{Simultation de l'image au plan de la caméra.}
    \label{arc-en-ciel}
\end{figure}
